...
The **Connecting a PaaS application to an IaaS Application with a Virtual Network - for Visual Studio 2012 Hands-on Lab** is licensed under the terms of the Apache License, Version 2.0.
